# https://github.com/AumitLeon/million-songs/blob/master/get_data.py
...
with open("output.csv", 'wb') as csvfile:
    ...
    csvfile.write(",".join(header).encode("utf-8"))
    ...
    for root, dirs, filenames in os.walk(indir):
        for f in filenames:
            ...
            artist_loc = artist_location.decode('utf-8').translate(string.punctuation)
            ...
            csvfile.write((artist + "," + title + "," + artist_loc + "," + release + "," + str(hotttness) + "," + str(
                familiarity) + "," + str(danceability) + "," + str(duration) + "," + str(energy) + "," + str(
                loudness) + "," + str(year) + "," + str(tempo) + "," + str(analysis_rate) + "," + str(
                end_of_fade_in) + "," + str(key) + "," + str(key_confidence) + "," + str(mode) + "," + str(
                mode_confidence) + "," + str(start_of_fade_out) + "," + str(time_signature) + "," + str(
                time_signature_conf) + "," + str(track_id)).encode('utf-8'))
